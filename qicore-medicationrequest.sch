...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile US Core Medication Request Profile
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationRequest">
      <sch:assert test="count(f:groupIdentifier) &lt;= 1">groupIdentifier: maximum cardinality of 'groupIdentifier' is 1</sch:assert>
      <sch:assert test="count(f:intent) &gt;= 1">intent: minimum cardinality of 'intent' is 1</sch:assert>
      <sch:assert test="count(f:intent) &lt;= 1">intent: maximum cardinality of 'intent' is 1</sch:assert>
      ...
      <sch:assert test="count(f:authoredOn) &lt;= 1">authoredOn: maximum cardinality of 'authoredOn' is 1</sch:assert>
      <sch:assert test="count(f:recorder) &lt;= 1">recorder: maximum cardinality of 'recorder' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
