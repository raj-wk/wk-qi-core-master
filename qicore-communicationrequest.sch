...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CommunicationRequest">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/communicationrequest-orderedBy']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/communicationrequest-orderedBy': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/procedurerequest-authorizedBy']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/procedurerequest-authorizedBy': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/communicationrequest-reasonRejected']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/communicationrequest-reasonRejected': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
