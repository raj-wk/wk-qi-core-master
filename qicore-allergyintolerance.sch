...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile US Core Allergies Profile
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:AllergyIntolerance">
      ...
      <sch:assert test="not(f:status/@value != 'refuted' and f:extension/@url='http://hl7.org/fhir/StructureDefinition/allergyintolerance-reasonRefuted')">extension: reasonRefuted is only permitted if status is refuted</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
