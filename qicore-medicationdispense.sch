...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationDispense">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/medicationdispense-validityPeriod']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/medicationdispense-validityPeriod': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/pharmacy-core-refillsRemaining']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/pharmacy-core-refillsRemaining': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>f:MedicationDispense/f:dosageInstruction/f:extension</sch:title>
    <sch:rule context="f:MedicationDispense/f:dosageInstruction/f:extension">
      ...
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &lt;= 1">url: maximum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:valueDuration) &lt;= 1">valueDuration: maximum cardinality of 'valueDuration' is 1</sch:assert>
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &lt;= 1">url: maximum cardinality of 'url' is 1</sch:assert>
